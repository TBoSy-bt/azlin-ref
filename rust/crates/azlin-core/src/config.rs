...
// Re-export validation constants and functions for backward compatibility
pub use crate::validation::{validate_azure_region, validate_vm_name, VALID_AZURE_REGIONS};
...
impl AzlinConfig {
    ...
    pub fn validate_field(key: &str, value: &str) -> crate::Result<serde_json::Value> {
        // Use match for better performance and clarity
        match key {
            "default_region" => {
            ...
            "ssh_sync_method" => {
                return match value.to_lowercase().as_str() {
                    ...
                    _ => Err(crate::AzlinError::Config(format!(
            ...
            _ if Self::U64_FIELDS.contains(&key) => {
